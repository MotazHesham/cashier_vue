...
class ProductApiController extends Controller
{
    public function index()
    {
        ...
        return new ProductResource(Product::with(['category'])->advancedFilter());
    }
    ...
    public function store(StoreProductRequest $request)
    {
        ...
        $product->attributes()->sync($request->input('attributes.*.id', []));
    ...
    public function edit(Product $product)
    {
        ...
        return response([
            'data' => new ProductResource($product->load(['category', 'attributes'])),
            'meta' => [
                'category'   => ProductCategory::get(['id', 'name']),
                'attributes' => Attribute::get(['id', 'attribute']),
            ],
